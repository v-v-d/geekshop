...
urlpatterns = [
    ...
    # url(r'^products/all/$', cache_page(3600)(mainapp.products), name='products'),
    # url(r'^products/all/(?P<page>\d+)/$', cache_page(3600)(mainapp.products), name='catalog'),
    # url(r'^products/category/(?P<pk>\d+)/$', cache_page(3600)(mainapp.products), name='category'),
    # url(r'^products/category/(?P<pk>\d+)/(?P<page>\d+)/$', cache_page(3600)(mainapp.products), name='page'),


    # url(r'^products/all/ajax/$', cache_page(3600)(mainapp.products_ajax)),
    # url(r'^products/all/(?P<page>\d+)/ajax/$', cache_page(3600)(mainapp.products_ajax)),
    # url(r'^products/category/(?P<pk>\d+)/ajax/$', cache_page(3600)(mainapp.products_ajax)),
    # url(r'^products/category/(?P<pk>\d+)/(?P<page>\d+)/ajax/$', cache_page(3600)(mainapp.products_ajax)),
