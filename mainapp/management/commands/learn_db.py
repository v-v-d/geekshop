...
class Command(BaseCommand):
    ...
    #     test_products = Product.objects.filter(Q(category__name='Home') | Q(category__name='Furniture')).select_related()
    #
    ...
    #         db_profile_by_type('learn db', '', connection.queries)
        ...
        ACTION_1, ACTION_2, ACTION_EXPIRED = 1, 2, 3

        action_1__time_delta, action_2__time_delta = timedelta(hours=12), timedelta(days=1)

        action_1__discount, action_2__discount, action_expired__discount = 0.3, 0.15, 0.05
